...
As a graduate student in the Grotjahn lab, Michaela co-developed the [Surface Morphometrics](https://github.com/GrotjahnLab/surface_morphometrics) software pipeline to quantify membrane architecture from cryo-ET data. After earning her PhD in 2025, she transitioned to postdoctoral researcher to investigate the role of prohibitins in adapting mitochondrial structure and function in response to cellular stress.
